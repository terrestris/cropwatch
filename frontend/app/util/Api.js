    ...
    return new Promise((resolve, reject) => {
      this.importListener = event => {
        ...
        if (json.entityImportDone) {
          websocket.removeEventListener('message', this.importListener);
      ...
      // TODO: Why do we create a new listener every time. Do we need to remove it?
      websocket.addEventListener('message', this.importListener);
