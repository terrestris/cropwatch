...
class FloatingSelectCellEditor extends React.Component {
  ...
  static propTypes = {
    ...
    remoteSelectFieldFilterFunction: PropTypes.func
  };
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      associatedModelDisplayField: associatedModelDisplayFields[modelName] || 'name'
    };
  }
  ...
  render() {
    const {
      attribute,
      remoteSelectFieldFilterFunction,
      node
    } = this.props;
    ...
    if (node.rowPinned) {
      ...
      if(this.state.isAssociationCol){
        ...
        return <RemoteSelectField
          ...
          filterFunction={remoteSelectFieldFilterFunction}
