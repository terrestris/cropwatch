  ...
  render() {
    ...
    return (
      <Form className="registration-form" layout="vertical">
        ...
        <Form.Item
          label={t('RegistrationForm.projectPassword')}
          required
          hasFeedback
          validateStatus={projectPassword ? 'success' : 'error'}
        >
          <Input
            type="password"
            onChange={event => this.changeHandler('projectPassword', event.target.value)}
