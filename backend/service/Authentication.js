...
const projectPassword = require('../config/projectPassword')
...
class AuthenticationService {
  ...
  async register(userData) {
    ...
    if (pp !== projectPassword) {
      logger.warn('Registration failed. Wrong project password.');
      return {
        success: false,
        message: "Project password wrong."
      };
    }
